...
class AestheticsAgent(BaseAgent):
    """
    An agent that analyzes the aesthetic style of images.
    """
    ...
    async def _process_message_impl(self, message: AgentMessage) -> AgentMessage:
        ...
        content = [{
            "type": "text",
            "text": "Analyze the following images and describe their overall aesthetic, mood, and style (e.g., vintage, modern, photographic, minimalist). Mention any artistic influences you can discern. Your analysis will be used to generate a Midjourney prompt."
        }]
        ...
        try:
            ...
            return self._create_error_response(message.sender_id, f"Failed to analyze aesthetics with OpenAI: {e}")

        return AgentMessage(
            sender_id=self.agent_id,
            recipient_id=message.sender_id,
            content={"aesthetics_analysis": analysis},
