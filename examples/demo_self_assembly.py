"""
Example script: self-assembly demo (originally demo_self_assembly.py)

Run from project root:
    python -m examples.demo_self_assembly

Or:
    PYTHONPATH=. python examples/demo_self_assembly.py
"""
import asyncio
